...
dotnet run --project src/RequestWriter/RequestWriter.csproj -- --light 2>&1 | tail -3
echo ""
...
dotnet run --project src/RequestWriter/RequestWriter.csproj -- --moderate 2>&1 | tail -3
echo ""
...
dotnet run --project src/RequestWriter/RequestWriter.csproj -- --rush 2>&1 | tail -3
echo ""
